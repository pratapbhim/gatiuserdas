...
export default function ParcelHeroPage() {
  const [section, setSection] = useState<SectionData>({
    id: 'parcel-hero-1',
    type: 'Hero',
    heading: 'Send Parcels With Ease',
    subtitle: 'Fast, reliable, and secure parcel delivery',
    imageUrl: '/img/parcel-hero.jpg',
    imageAlt: 'Parcel delivery hero',
    buttonText: 'Send Parcel',
    buttonLink: '/parcel/send',
        ...
        <div className="flex-1">
          <div className="mb-4">
            <h1 className="text-3xl font-bold text-gray-900 mb-2">
              Parcel Service - Hero Section
            </h1>
            <p className="text-gray-600">Edit the hero section for parcel delivery</p>
          </div>
